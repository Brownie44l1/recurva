...
<h2 style="margin:0 0 8px;font-size:22px;font-weight:600;color:#18181b;letter-spacing:-.3px">Reset your password</h2>
<p style="margin:0 0 8px;font-size:16px;line-height:1.5;color:#52525b">Hi ${data.name},</p>
<p style="margin:0 0 24px;font-size:16px;line-height:1.5;color:#52525b">We received a request to reset your password. Click the button below to set a new password. This link expires in 1 hour.</p>
<a href="${data.resetUrl}" style="display:inline-block;padding:12px 28px;font-size:15px;font-weight:600;color:#fff;background:#18181b;border-radius:6px;text-decoration:none">Reset Password</a>
<p style="margin:24px 0 0;font-size:14px;line-height:1.5;color:#a1a1aa">If you did not request a password reset, please ignore this email or contact support.</p>
</td></tr>
